...
import styles from './SyncfusionGridWebPart.module.scss';
import * as strings from 'SyncfusionGridWebPartStrings';
...
export interface ISyncfusionGridWebPartProps {
  description: string;
}

export default class SyncfusionGridWebPart extends BaseClientSideWebPart<ISyncfusionGridWebPartProps> {
  ...
  public render(): void {
    ...
    <section class="${styles.syncfusionGrid} ${!!this.context.sdks.microsoftTeams ? styles.teams : ''}">
